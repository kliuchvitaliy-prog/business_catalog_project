          ...
          <>
            <div style={{ marginBottom: 28 }}>
              ...
              >
                ...
                Нажмите на карточку, чтобы увидеть полный профиль, или отметьте до пяти вариантов для сравнения.
              </p>
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#5C6270", marginTop: 8 }}>
  Информационный проект, не является индивидуальной инвестиционной рекомендацией
</p>
            </div>
            <FilterPanel
              budget={budget}
